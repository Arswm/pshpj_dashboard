    ...
    <div className="container">
      <div className="flex gap-4 w-full">
            ...
            <Tabs defaultValue="content" className="w-full" dir={'rtl'}>
                  ...
                  <section className={'bg-tabs-gray rounded px-8 p-2'}>
                    ...
                    <div className={'border bg-white rounded p-4 space-y-3'}>
                      <div className={'flex justify-between items-center'}>
                        <p>به موتور های جستجو اجازه دهید این محتوا را در نتایج نشان دهند ؟</p>
                        <Switch />
                      </div>
                      <div className={'flex justify-between items-center'}>
                        <p>به موتور های جستجو اجازه دهید این محتوا را در نتایج نشان دهند ؟</p>
                ...
                <div className={'border-b border-r border-l space-y-4 pt-4 p-4 bg-white'}>
                  ...
                  <section className={'bg-tabs-gray rounded p-2'}>
                    <div className={'px-8 mt-4'}>
                      <h3 className={'text-primary text-lg font-medium'}>تصاویر شاخص مقاله</h3>
                  ...
                  <section className={'bg-tabs-gray rounded p-2'}>
                    <div className={'px-8 mt-4'}>
                      <h3 className={'text-primary text-lg font-medium'}>تصاویر مقاله</h3>
              ...
              <TabsContent className={'mt-0'} value="schema">
                <div className={'border-b border-r border-l space-y-4 pt-4 p-4 bg-white'}>
                  <section className={'bg-tabs-gray rounded px-8 p-2'}>
                    {/*dont repeat yourself*/}
                    <h3 className={'text-primary text-lg font-medium'}>ویدیو مقاله</h3>
                    <div className={'flex flex-col gap-4'}>
                      ...
                      <div className={'mb-4'}>
                        <div className={'flex gap-4 items-center my-2'}>
                          <Label className={'w-1/4'}>آپارات / یوتیوب</Label>
                          <Input className={'w-3/4'} />
                        </div>
                      </div>
                      ...
                      <div className={'mb-4'}>
                        <div className={'flex gap-4 items-center my-2'}>
                          <Label className={'w-1/4'}>لینک کاور ویدیو</Label>
                          <Input className={'w-3/4'} />
                        </div>
                      </div>
                  ...
                  <section className={'bg-tabs-gray rounded px-8 p-2'}>
                    {/*dont repeat yourself*/}
                    <h3 className={'text-primary text-lg font-medium'}>جدول مقالات</h3>
                    <div className={'flex flex-col gap-4'}>
                      <div className={'mb-4'}>
                        <div className={'flex justify-end'}>
                          <Button
                  ...
                  <section className={'bg-tabs-gray rounded px-8 p-2'}>
                    {/*dont repeat yourself*/}
                    <h3 className={'text-primary text-lg font-medium'}>سوالات متداول</h3>
                    <div className={'flex flex-col gap-4 mt-8'}>
                      ...
                      <div className={'mb-4'}>
                        <div className={'flex gap-4 items-center my-2'}>
                          <Label className={'w-1/4'}>توضیحات برای ساخت</Label>
                          <Input className={'w-3/4'} />
                        </div>
                        <div className={'flex justify-end'}>
                          <Button
                      ...
                      <div className={'grid gap-4 md:grid-cols-3'}>
                        <div className={'bg-white shadow rounded-lg p-4'}>
                          <h3 className={'font-medium text-[16px]'}>سوال اینجا میاد</h3>
                          <div className={'bg-primary h-1 rounded-lg my-3 w-full'}></div>
                          <p className={'text-sm text-slate-400 text-justify'}>
                            لورم ایپسوم متن ساختگی است برای ایم پارد نشسید مکشسی نشسیننکشس نیحشس
                            مشیمشم سنی
                          </p>
                        </div>
                        <div className={'bg-white shadow rounded-lg p-4'}>
              ...
              <TabsContent className={'mt-0'} value="element">
                <div className={'border-b border-r border-l space-y-4 pt-4 p-4 bg-white'}>
                  <div className={'bg-tabs-gray rounded p-2'}>element</div>
                </div>
              </TabsContent>
            </Tabs>
          </form>
        ...
        <div className={'w-1/4 rounded-lg p-2 '}>
          ...
          <div
            className={
              'flex bg-white py-4 px-1 rounded-lg border items-center gap-1.5 ps-4 mb-8 h-16'
            }
          >
            <Image
              src={'/images/blog-page/user-image.jpg'}
              width={40}
              height={40}
              alt={'user icon'}
              className={'w-10 h-10 object-cover rounded-md'}
            />
            <p className={'text-gray-500'}>محمد امین عابدی (مدیر)</p>
          </div>
          <p className={'mb-2'}>زمان انتشار</p>
          <div className={'flex gap-4 text-gray-400'}>
            ...
            <div
              className={
                'bg-white border rounded-lg py-2 px-4 flex items-center gap-2 grow h-11 w-1/2'
              }
            >
              <CalendarDays />
              2025/02/01
          ...
          <p className={'mt-4'}>نامک</p>
          <div className={'flex gap-4 text-gray-400 mt-1'}>
            <div
              className={'bg-white border rounded-lg py-2 px-4 flex items-center gap-4 w-full h-11'}
            >
              <Newspaper />
