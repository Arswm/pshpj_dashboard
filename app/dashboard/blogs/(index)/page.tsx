...
function Page() {
  return (
      <div className={'container'}>
        <section
            className={"grid md:grid-cols-5 gap-4 border bg-white shadow-md"}
        >
          <Link
              href={"#"}
              className={"flex items-center gap-2 p-2 rounded border-e py-6"}
          >
            <div
                className={
          ...
          <Pagination className="justify-end mt-4 text-gray-600">
            <PaginationContent>
              ...
              <PaginationItem className="flex gap-2">
                <PaginationLink className="bg-white shadow rounded" href="#">1</PaginationLink>
                <PaginationLink className="bg-white shadow rounded" href="#">2</PaginationLink>
                <PaginationLink className="bg-white shadow rounded" href="#">3</PaginationLink>
              </PaginationItem>
              <PaginationItem>
