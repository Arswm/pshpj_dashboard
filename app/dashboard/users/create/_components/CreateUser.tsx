...
export default function CreateUserForm({ roles }: IProps) {
  const {
    register,
    control,
    handleSubmit,
  ...
  return (
    <form
      ...
      className="bg-white shadow rounded-lg p-6 grid grid-cols-2 gap-14 text-gray-600"
    >
      <div className="grid grid-cols-2 gap-4">
        ...
        <TextInput name="phone" label="شماره موبایل" register={register} />
        {errors.phone && (
          <Alert variant={'destructive'} className="py-2.5 px-2">
            <AlertDescription className="text-xs py-0 px-0">
