    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            'group-[.toast]:!bg-inherit group-[.toast]:!text-gray-600 dark:group-[.toast]:bg-neutral-50 dark:group-[.toast]:text-neutral-900',
          cancelButton:
            'group-[.toast]:bg-inherit group-[.toast]:text-neutral-500 dark:group-[.toast]:bg-neutral-800 dark:group-[.toast]:text-neutral-400',
        },
      }}
      {...props}
    />
