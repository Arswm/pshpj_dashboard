...
export default function Footer() {
  return (
    <footer className="w-full mt-20  relative  before:content-[''] before:absolute before:inset-0 before:size-full before:bg-[#003E92]/70">
      {/* background */}
      <Image
        src={FooterBackgroundImage}
        alt="footer background"
        className="h-[1500px] md:h-[930px] lg:h-[560px] block w-full object-cover object-center"
      />

      {/* content */}
      <div className="absolute  inset-0 py-16 lg:py-10 px-6 space-y-10   max-w-6xl h-full mx-auto z-50">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 ">
          <div className="bg-white text-primary flex flex-col gap-4 p-6 rounded">
            <Link href="#" className="text-base font-semibold lg:text-sm">
              معرفی آژانس چاپ و تبلیغات چاپزی
            </Link>
            <div className="flex justify-end">
              <Link href="#" className="flex gap-x-1 items-center text-sm">
                <p>بیشتر بخوانید</p>
        ...
        <div className="size-full gap-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center h-fit">
          ...
          <div className="grid grid-cols-2 gap-1 text-sm">
            <Link
              target="_blank"
              className="block focus:bg-zinc-600 text-white transition-all p-2.5"
